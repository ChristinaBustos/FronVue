...
import { DeletePersonInteractor } from "../use-cases/delete-person.interactor";
...
export class PersonController {
    ...
    deletePerson(payload:number){
        const repo: PersonRepository = new PersonStorageGateway();
        const interactor: DeletePersonInteractor = new DeletePersonInteractor(repo);
